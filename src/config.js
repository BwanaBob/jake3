module.exports = {
   ...
   jobs: {
      blueSkyPostBingo:{
         postText:"Happy Saturday, #OPNation! #OnPatrolLive starts in just one hour! Get your bingo cards and come play along.\nwww.thatsabingo.com\n#OnPatrolLive #OPNation",
         imagePaths: [
            ...
            './resources/bingo-splash-v-wolf.png',
         ]
      },
      blueSkyPostThread:{
