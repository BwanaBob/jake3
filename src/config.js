   ...
   jobs: {
      ...
      getNewModLog: {
         ...
         actions: {
            ...
            acceptmoderatorinvite: { text: "Accept Moderator Invite", enabled: true }, 
            ...
            removewikicontributor: { text: "Remove Wiki Contributor", enabled: true }, 
            ...
            community_welcome_page: { text: "Community Welcome Page", enabled: true }, 
            community_widgets: { text: "Community Widgets", enabled: true }, 
            markoriginalcontent: { text: "Mark Original Content", enabled: true }, 
            collections: { text: "Collections", enabled: true }, 
            events: { text: "Events", enabled: true }, 
            hidden_award: { text: "Hidden Award", enabled: true }, 
            add_community_topics: { text: "Add Community Topics", enabled: true }, 
            remove_community_topics: { text: "Remove Community Topics", enabled: true }, 
            create_scheduled_post: { text: "Create Scheduled Post", enabled: true }, 
            edit_scheduled_post: { text: "Edit Scheduled Post", enabled: true }, 
            delete_scheduled_post: { text: "Delete Scheduled Post", enabled: true }, 
            submit_scheduled_post: { text: "Submit Scheduled Post", enabled: true }, 
            edit_comment_requirements: { text: "Edit Comment Requirements", enabled: true }, 
            edit_post_requirements: { text: "Edit Post Requirements", enabled: true }, 
            invitesubscriber: { text: "Invite Subscriber", enabled: true }, 
            submit_content_rating_survey: { text: "Submit Content Rating Survey", enabled: true }, 
            adjust_post_crowd_control_level: { text: "Adjust Post Crowd Control Level", enabled: true }, 
            enable_post_crowd_control_filter: { text: "Enable Post Crowd Control Filter", enabled: true }, 
            disable_post_crowd_control_filter: { text: "Disable Post Crowd Control Filter", enabled: true }, 
            deleteoverriddenclassification: { text: "Delete Overridden Classification", enabled: true }, 
            overrideclassification: { text: "Override Classification", enabled: true }, 
            ...
            createremovalreason: { text: "Create Removal Reason", enabled: true }, 
            updateremovalreason: { text: "Update Removal Reason", enabled: true }, 
            deleteremovalreason: { text: "Delete Removal Reason", enabled: true }, 
            reorderremovalreason: { text: "Reorder Removal Reason", enabled: true }, 
            dev_platform_app_changed: { text: "Dev Platform App Changed", enabled: true }, 
            dev_platform_app_disabled: { text: "Dev Platform App Disabled", enabled: true }, 
            dev_platform_app_enabled: { text: "Dev Platform App Enabled", enabled: true }, 
            dev_platform_app_installed: { text: "Dev Platform App Installed", enabled: true }, 
            dev_platform_app_uninstalled: { text: "Dev Platform App Uninstalled", enabled: true }, 
            edit_saved_response: { text: "Edit Saved Response", enabled: true }, 
            chat_approve_message: { text: "Chat Approve Message", enabled: true }, 
