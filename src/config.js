module.exports = {
   ...
   jobs: {
      blueSkyPostBingo:{
         postText:"🚨 Happy Friday, #OPNation! #OPLive kicks off in one hour. Grab your bingo cards and play along with us! 🤖\n➡️ www.thatsabingo.com\n#OPLive #OnPatrolLive",
         singleImage: "./resources/bingo-splash-baby-grad.png",
         imagePaths: [
